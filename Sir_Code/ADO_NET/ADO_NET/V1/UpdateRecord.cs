...
namespace ADO_NET.V1 {
    public partial class UpdateRecord : Form {
        ...
        private void button3_Click(object sender, EventArgs e) {
            ...
            string sql = "UPDATE persons SET full_name='"+textBox2.Text+"', contact_address='"+textBox3.Text+"' WHERE pid="+int.Parse(textBox1.Text);
            ...
            try {
                ...
                if (result == 1) {
                    ...
                    MessageBox.Show("Error to update record");
                }
            }
            catch (Exception ex) {
